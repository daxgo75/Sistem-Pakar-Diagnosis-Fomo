    ...
    <div class="max-w-md mx-auto p-6">
        <div class="bg-white rounded-xl shadow-md overflow-hidden p-6 border border-gray-100">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-500 text-sm mt-1">Perbarui informasi penyakit</p>
            </div>
            ...
            <form action="{{ route('admin.penyakit.update', $penyakit->id) }}" method="POST" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative">
                        <input type="text" id="kode_p" name="kode_p" value="{{ old('kode_p', $penyakit->kode_p) }}"
                            required
